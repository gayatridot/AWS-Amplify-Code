...
window._workshopConfig = {
  cognito: {
    userPoolId: 'us-east-1_mJgmBxIq3', // e.g. us-west-2_uXboG5pAb
    userPoolClientId: '1vfhqmidsb5e6qss86dsnnm7d4', // e.g. 25ddkmj4v6hfsfvruhpfi7n4hv
    region: 'us-east-1' // e.g. us-west-2
  },
  api: {
    invokeUrl: 'https://a4j6moqrub.execute-api.us-east-1.amazonaws.com/dev' // e.g. https://abc123def.execute-api.us-west-2.amazonaws.com/prod
  }
};
